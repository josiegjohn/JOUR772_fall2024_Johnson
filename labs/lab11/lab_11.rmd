...
**A1. The top word is "disbarred," and the top 10 seem to say that many lawyers have been disbarred... immediately in the month of September in Arizona. Of course, this is assuming we take it literally, which we shouldn't.**
...
**A2. "Trust account," appears at the top and is used a total of 412 times. A trust account is an account in which funds/assets are held for a trustee.**

Edit: I tried to make it trigrams but it didn't work
...
conduct <- md_attorney_sanctions |>
  filter(str_detect(text, "trust account NA"))
