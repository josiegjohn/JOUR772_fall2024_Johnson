...
\*NOTE: vertical line is "or" the & sign is "and"
...
**Answer: it actually sees the dates, instead of seeing them as words. it also looks slightly different, year month day.**
...
**Answer the dates are not in order by appearance**
...
**I think I am still a bit confused on what to expect from that data, so if this is showing something weird about that I would not know. It looks like they're giving a lot of money to other states. But the code makes sense, like how we've presumably combined "Maryland" and "MD" to get the total amount of money from MD.**
...
1.  Where is the most out-of-state money going? Is it all one thing, like a federal grant?

2.  Could we find a way to search all of the N/A states to see if they left a state name somewhere else in an entry?

3.  What class is offered the most, with the highest number of seats, and what department is it?
