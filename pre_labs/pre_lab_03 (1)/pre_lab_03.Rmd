...
**Task** Write and run code to answer our original question: which zip code has gotten the most amount of money from the Maryland Tourism Board? Does that zip code make sense to you? I got that the zipcode 20772 in 2017 got the most, the zipcode makes sense because I used zip5 instead of zip_codes
...
# pls ignore that its late i had technical issues
