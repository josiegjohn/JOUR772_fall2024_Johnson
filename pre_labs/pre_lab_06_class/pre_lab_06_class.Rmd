...
county_voters_2022 <- county_voters_2022 |>
  rename(TOTAL = Total)
#if you run more than once itll say error bc Total is gone and changed to TOTAL
...
maryland_zcta_assessment <- maryland_zcta |>
  left_join(assessment, join_by(ZCTA5N==zipcode))
```
