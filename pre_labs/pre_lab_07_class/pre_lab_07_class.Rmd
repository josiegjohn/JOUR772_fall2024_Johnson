...
#delete before save and upload to github
```
...
# load variables shows what variables are available in census for any given year, it created the data tables to the side
...
#don't trust small numbers in census
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer Utah**
...
md <- get_acs(geography = "county",
              ...
              state = "MD",
              year = 2022)
#this time were just interested in md counties, selecting state 
# the c is change, names b1 shit medincome
...
**Add your answer here: Baltimore City (counted as a county) and Garrett County.**
