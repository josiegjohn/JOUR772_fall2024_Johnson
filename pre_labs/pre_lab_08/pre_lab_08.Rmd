...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer 24, 18**
...
**Task** Complete and run the following code to create a dataframe of top 10 counties with the biggest change in unaffiliated voters in Maryland. In the space below, explain what each step of the code below is doing in English. **Answer calculating the difference in years and then showing the biggest differences**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer It's a blank canvas**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A very simple graph, but the category names are bunched together and it's ugly**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer Its organized small to large now**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer it flipped, the names are easier to read now**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer the chart, without grey background**
...
**Task** Run the following code. **Answer we downloaded... a theme**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer gave us a theme**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer added big title that doesn't fit, flip x and y**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see a lists of dates and total contributions**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I see a funky link graph**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer We've made the chart longer, switching the measurement to days**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer changed angle of the labels to make it less cluttered**
