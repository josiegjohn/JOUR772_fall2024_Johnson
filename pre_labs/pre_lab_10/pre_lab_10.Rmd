...
**Task** Run the following code. Describe the output in the space below. **Answer : Charles County has the highest rate of change, other than that it's fairly equal between the three other rates of change.**
