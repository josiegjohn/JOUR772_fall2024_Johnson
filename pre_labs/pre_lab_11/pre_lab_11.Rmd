...
**Task** Run the following code and describe the dataframe it outputs. **Answer there is a lot going on in there**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer made all words lowercase and listed them individually in a dataset**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer no... just stop words**
...
```{r}
data("stop_words")
#what words are pretty much useless? get rid of them
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer yes**
...
**Task** Run the following code and describe the results. **Answer health falls**
...
I think it's very difficult for it to be accurate using a binary system like this. And "Trump" being labeled positive is pretty funny.
