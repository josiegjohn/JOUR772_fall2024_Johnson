...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer hardly a pattern but seems to be going up**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer now its tilting down, but slightly**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer the table shows term and per pupils, gdp growth, and population change in 2021. but the p value is missing**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer i see some crazy stuff man. Apparently we're calculating the p value**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer still weird, but has some good information. The p value has gone up.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer votes for biden vs trump**
...
**Task** Run the following code. Describe the output. What do you see? **Answer The t is negative here**
...
**Task** Run the following code. Describe the output. What do you see? **Answer the t is higher now, there's a significant difference**
