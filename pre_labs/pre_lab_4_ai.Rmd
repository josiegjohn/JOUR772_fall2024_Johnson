...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
# ask function to ask sir groq a question, prompt explains something?
...
# paste is combining two things together, combine text into a prompt and something you want to feed to the prompt
...
```{r}
idea_response <- axolotr::ask(
  prompt = "How is grouping different than summarizing in R?",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: To my knowledge, it's correct. And can be used responsibly to answer any small hyper-specific questions when not in class.**
