...
**A4: I have 6 over 6, I technically got it first by arranging descending by highest (because I knew there were only a few over six) but then filtered because that would work better in another data set, probably.**
...
**A6: 7,474 rows of earthquakes that fit one or the other**
...
#? question mark then function will tell you what the ffunction does
```

**A7: There have been 2,168 earthquakes counted in Alaska in the last hour, out of our records**
...
**A8: earthquakes and explosions with 8996 and 67 respectively**
...
**A9: earthquake is 19.4, explosion is -0.24, landslide is 0, blast is -.59**

------------------------------------------------------------------------

#### **xxxxxxxQ10** I'm interested, in the future, to see the hours in which earthquakes happen. How can I extract the hour from the time column?
